...
cfg_int g_lengthIntercept(GUID_lengthModifierAdd, 540);
...
cfg_float g_lengthModifier(GUID_lengthModifierMul, 0.25f);

// {7BFAF825-D62A-43c0-87F7-B8A010829512}
static const GUID GUID_longTrackModifier = 
{ 0x7bfaf825, 0xd62a, 0x43c0, { 0x87, 0xf7, 0xb8, 0xa0, 0x10, 0x82, 0x95, 0x12 } };
cfg_int g_longTrackModifier(GUID_longTrackModifier, 10480);
...
cfg_float g_agePenalty(GUID_agePenalty, 1.3f);
...
cfg_int g_delayPenalty(GUID_delayPenalty, 500);
